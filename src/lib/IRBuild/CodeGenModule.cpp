...
std::shared_ptr<ReturnInst> ModuleBuilder::CreateAggregateRet(
    [[maybe_unused]] std::vector<std::shared_ptr<Value>> retVals,
    [[maybe_unused]] unsigned N) {
  return nullptr;
}

std::shared_ptr<BranchInst>
ModuleBuilder::Create(std::shared_ptr<BasicBlock> Dest) {
  return InsertHelper(BranchInst::Create(Context, CurBB, Dest), "");
}

std::shared_ptr<BranchInst>
ModuleBuilder::CreateCondBr(std::shared_ptr<Value> Cond,
                            std::shared_ptr<BasicBlock> True,
                            std::shared_ptr<BasicBlock> False) {
  return InsertHelper(BranchInst::Create(Context, True, False, Cond, CurBB),
                      "");
}

std::shared_ptr<BranchInst>
ModuleBuilder::CreateBr(std::shared_ptr<BasicBlock> Dest) {
...
ModuleBuilder::CreateInsertBinOp(BinaryOperator::Opcode Opc,
...
std::shared_ptr<Value> ModuleBuilder::CreateAdd(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
    if (std::shared_ptr<ConstantInt> RC =
            std::dynamic_pointer_cast<ConstantInt>(RHS))
      return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateSub(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateMul(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateDiv(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateRem(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateShl(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateShr(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> LC =
          std::dynamic_pointer_cast<ConstantInt>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateAnd(std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  if (std::shared_ptr<ConstantBool> LC =
          std::dynamic_pointer_cast<ConstantBool>(LHS)) {
    if (std::shared_ptr<ConstantBool> RC =
            std::dynamic_pointer_cast<ConstantBool>(RHS))
      return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateOr(std::shared_ptr<Value> LHS,
                                               std::shared_ptr<Value> RHS,
                                               std::string Name) {
  if (std::shared_ptr<ConstantBool> LC =
          std::dynamic_pointer_cast<ConstantBool>(LHS)) {
...
std::shared_ptr<Value> ModuleBuilder::CreateNeg(std::shared_ptr<Value> V,
                                                std::string Name) {
  if (std::shared_ptr<ConstantInt> VC =
          std::dynamic_pointer_cast<ConstantInt>(V))
    return InsertHelper(ConstantFolder::CreateNeg(Context, VC), Name);
  return InsertHelper(BinaryOperator::CreateNeg(Context, V, CurBB));
}

std::shared_ptr<Value> ModuleBuilder::CreateNot(std::shared_ptr<Value> V,
                                                std::string Name) {
  if (std::shared_ptr<ConstantBool> VC =
          std::dynamic_pointer_cast<ConstantBool>(V))
...
std::shared_ptr<AllocaInst> ModuleBuilder::CreateAlloca(TyPtr Ty,
                                                        std::string Name) {
  return InsertHelper(AllocaInst::Create(Ty, CurBB), Name);
}

std::shared_ptr<LoadInst>
ModuleBuilder::CreateLoad(std::shared_ptr<Value> Ptr) {
  return InsertHelper(LoadInst::Create(Ptr, CurBB));
}

std::shared_ptr<StoreInst>
ModuleBuilder::CreateStore(std::shared_ptr<Value> Val,
                           std::shared_ptr<Value> Ptr) {
  return InsertHelper(StoreInst::Create(Context, Val, Ptr, CurBB), "");
}

std::shared_ptr<GetElementPtrInst> ModuleBuilder::CreateGEP(
    [[maybe_unused]] TyPtr Ty, [[maybe_unused]] std::shared_ptr<Value> Ptr,
    std::vector<unsigned> IdxList, [[maybe_unused]] std::string Name) {
...
std::shared_ptr<GetElementPtrInst>
ModuleBuilder::CreateGEP(TyPtr Ty, std::shared_ptr<Value> Ptr, unsigned Idx,
                         std::string Name) {
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpEQ(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpNE(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpGT(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpGE(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpLT(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmpLE(std::shared_ptr<Value> LHS,
                                                  std::shared_ptr<Value> RHS,
                                                  std::string Name) {
  return InsertHelper(
...
std::shared_ptr<Value> ModuleBuilder::CreateCmp(CmpInst::Predicate P,
                                                std::shared_ptr<Value> LHS,
                                                std::shared_ptr<Value> RHS,
                                                std::string Name) {
  // ���ж��ܷ����constant folder
...
std::shared_ptr<PHINode> ModuleBuilder::CreatePHI(TyPtr Ty,
                                                  unsigned NumReservedValues,
                                                  std::string Name) {
  return InsertHelper(PHINode::Create(Ty, NumReservedValues), Name);
}

std::shared_ptr<CallInst>
ModuleBuilder::CreateCall(std::shared_ptr<Value> Callee,
                          std::vector<std::shared_ptr<Value>> Args) {
  return InsertHelper(CallInst::Create(Callee, Args, CurBB));
}

std::shared_ptr<CallInst>
ModuleBuilder::CreateIntrinsic(std::shared_ptr<Intrinsic> Intr,
                               std::vector<std::shared_ptr<Value>> Args) {
  return InsertHelper(CallInst::Create(Intr, Args, CurBB));
}
std::shared_ptr<ExtractValueInst> ModuleBuilder::CreateExtractValueValue(
    std::shared_ptr<Value> Agg, std::vector<unsigned> Idxs, std::string Name) {
...
ModuleBuilder::CreateIsNull([[maybe_unused]] std::shared_ptr<Value> Arg,
...
std::shared_ptr<Value>
ModuleBuilder::CreateIsNotNull([[maybe_unused]] std::shared_ptr<Value> Arg,
                               [[maybe_unused]] std::string Name) {
...
ModuleBuilder::CreateBasicBlock(std::string Name,
