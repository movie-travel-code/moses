...
namespace compiler
{
	namespace IR
	{
		...
		public:
			...
			//===--------------------------------------------------------------===//
			static ConstantIntPtr CreateArithmetic(MosesIRContext& Ctx, BinaryOperator::Opcode Op, 
			...
			//===--------------------------------------------------------------===//
			static ConstantBoolPtr CreateBoolean(MosesIRContext& Ctx, BinaryOperator::Opcode Op, 
			...
			static ConstantBoolPtr CreateCmp(MosesIRContext& Ctx, CmpInst::Predicate P, ConstantIntPtr LHS,
				ConstantIntPtr RHS)
			{
				switch (P)
				{
